...
echo $this->Form->input('boletin', array('type'=>'checkbox','label'=>"<small>Deseo subscribirme al boletín de noticias <a href='http://www.crmotos.com/'>CRMotos.com</a></small>",'value' => 1));								
