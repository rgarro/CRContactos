...
<div class="users form">
	<div class="box-header btn-minimizeb  " data-original-title>
						<h2><i class="fa-icon-plus"></i><span class="break"></span> Crear Administrador para <?php echo $this->Session->read('agencia_nombre');?></h2>
						<div class="box-icon">
...
<?php				
			echo $this->Form->end(array("class"=>"btn btn-success","label"=>"Crear Administrador"));
		?>
</div>
</div>
<div class="actions">
